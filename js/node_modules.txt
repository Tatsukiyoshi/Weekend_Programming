...
`-- npm@6.9.0
  ...
  | | |   `-- path-exists@3.0.0
  | | `-- ini@1.3.5 deduped
  | +-- libnpmhook@5.0.2 deduped
  | +-- libnpmorg@1.0.0 deduped
  | +-- libnpmpublish@1.1.1
  ...
  | | +-- npm-package-arg@6.1.0 deduped
  | | +-- npm-registry-fetch@3.9.0 deduped
  | | +-- semver@5.6.0 deduped
  | | `-- ssri@6.0.1 deduped
  | +-- libnpmsearch@2.0.0 deduped
  | +-- libnpmteam@1.0.1 deduped
  | +-- lock-verify@2.1.0 deduped
  | +-- npm-lifecycle@2.1.0 deduped
  | +-- npm-logical-tree@1.2.1 deduped
  | +-- npm-package-arg@6.1.0 deduped
  | +-- npm-profile@4.0.1 deduped
  | +-- npm-registry-fetch@3.9.0 deduped
  | +-- npmlog@4.1.2 deduped
  | +-- pacote@9.5.0 deduped
  | +-- read-package-json@2.0.13 deduped
  | `-- stringify-package@1.0.0 deduped
  +-- libnpmaccess@3.0.1
  | +-- aproba@2.0.0
  | +-- get-stream@4.1.0
  | | `-- pump@3.0.0 deduped
  ...
  | +-- normalize-package-data@2.5.0 deduped
  | +-- npm-package-arg@6.1.0 deduped
  | +-- npm-packlist@1.4.1 deduped
  | +-- npm-pick-manifest@2.2.3 deduped
  | +-- npm-registry-fetch@3.9.0 deduped
  | +-- osenv@0.1.5 deduped
  | +-- promise-inflight@1.0.1 deduped
  | +-- promise-retry@1.1.1
