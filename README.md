...
**Kotlin**
  ...
  |環境／FW                                                     |端末       |日付      
  |-------------------------------------------------------------|-----------|----------
  |IntelliJ IDEA 2022.3                                         |IdeaPad    |2022/12/03
...
**JavaScript**
  ...
  1.  Windows
      ...
      |Angular 15.0.0 |           |2022/11/18
      |Deno 1.29.1    |           |2022/12/16
      |vite 4.0.1     |           |2022/12/16
...
**Dart/flutter**
  ...
  - flutter doctor -vの出力
    ...
    [√] Visual Studio - develop for Windows (Visual Studio Community 2022 17.5.0 Preview 2.0)
        • Visual Studio at D:\Program Files\Microsoft Visual Studio\2022\Preview
        • Visual Studio Community 2022 version 17.5.33209.295
...
**Rust**
  ...
  1. Windows 11
      |環境／FW     |端末       |日付
      |-------------|-----------|----------
      |Rust 1.66.0  |IdeaPad    |2022/12/29
      |Tauri 1.2.3  |           |2022/12/29
...
**Unity**
  - 「Unityによるモバイルゲーム開発」で学習中
    - [2D「Gnomes's Well」](https://github.com/Tatsukiyoshi/GnomesWell)をひとまず完了。
