...
**Kotlin**
  ...
  |環境／FW                                                       |端末       |日付      
  |---------------------------------------------------------------|-----------|----------
  |IntelliJ IDEA 2022.2.1                                         |IdeaPad    |2022/08/20
  |[PostgreSQL 14.5](https://www.postgresql.org/download/windows/)|           |2022/08/20
  |Amazon Coretto 17.0.4.1                                        |           |2022/08/20
...
1.  Chrome OS Flex 104.0.5112.110（Official Build）
    |FW            |端末       |日付      
    |--------------|-----------|----------
...
**Java**
  ...
  |[サーブレット＆JSP入門](https://github.com/Tatsukiyoshi/Weekend_Programming/issues/15)     |2022/06/04|3章 サーブレットの基礎 <span style="color: red;">*redo finished*</span>
