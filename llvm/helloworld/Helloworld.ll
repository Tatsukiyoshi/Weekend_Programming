...
target triple = "x86_64-unknown-windows-msvc19.27.29111"
...
$"??_C@_0M@LDICPMGJ@HelloWorld?6?$AA@" = comdat any

@"??_C@_0M@LDICPMGJ@HelloWorld?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [12 x i8] c"HelloWorld\0A\00", comdat, align 1
...
entry:
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"??_C@_0M@LDICPMGJ@HelloWorld?6?$AA@", i64 0, i64 0))
  ret i32 0
}
; Function Attrs: noinline nounwind optnone uwtable
...
!2 = !{!"compnerd.org clang version 10.0.0 (https://github.com/apple/llvm-project c39a810ec308dd4a8d93c5011fb73a5c987e8680)"}
